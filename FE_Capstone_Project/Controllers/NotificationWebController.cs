...
namespace FE_Capstone_Project.Controllers 
{
    public class NotificationWebController : Controller
    {
        ...
        private int GetCurrentUserId()
        {
            ...
            return userId.HasValue && userId.Value > 0 ? userId.Value : 0;
        }
        ...
        [HttpGet("api/[controller]/staff-count")]
        public async Task<IActionResult> GetStaffUnreadCount()
        {
            return await GetUnreadCount();
        }

        [HttpGet("api/[controller]/staff-alerts")]
        public async Task<IActionResult> GetStaffRecentNotifications()
        {
